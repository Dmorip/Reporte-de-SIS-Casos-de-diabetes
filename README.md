...
## 📸 Evidencias Logradas en Databricks (Resultados del Código)
...
- **Ingesta:** Lectura optimizada del catálogo de Hive Metastore (`workspace.default`).
- **Data Cleaning:**
...
### 2. Análisis Exploratorio Poblacional (EDA)
...
4. **Ejecuta la celda de limpieza una sola vez.** El script emplea buenas prácticas haciendo `.cache()` del DataFrame limpio, asegurando que el resto de consultas se resuelvan en fracción de segundos usando la memoria RAM del clúster.
